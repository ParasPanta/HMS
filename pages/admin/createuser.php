<?php
  ...
  try {
    if(isset($_GET["del"])){
        ...
        $del_sql = "DELETE FROM staffs where SN = '$sn'";
  ...
  <body class="dark">
    <div class="grid-section">
      ...
      <div class="right-section">
        <section class="home">
          <div class="text">View Staffs Unregistered as User</div>
        </section>
        <div class="content">
                    ...
                    while($row = mysqli_fetch_array($result)) {
                     ?>
                        ...
                        <?php
                            ...
                            $sql_try = "SELECT * from users WHERE (staff_id = '$staff_id_try')";
                            $result_try = mysqli_query($db, $sql_try);
                            $row_try = mysqli_fetch_array($result_try)

                        ?>


                     
                       <?php if(!isset($row_try)){ ?>
                            <tr>
                              ...
                              <div class='table-link viewonly'>
                                <a class='buttonLink create' href='createuser-next.php?SN=<?php echo $row['SN'] ?>'>Create</a>
                              </div>
                              </td>
                        </tr>
                          <?php 
