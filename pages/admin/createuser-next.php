              ...
              <div class="formgrid createuser">
                ...
                <div>
                  <div class="forminput">
                    ...
                    <input name='username' type="text" class='search-area' placeholder="Enter Username"
                      autocomplete='off' />
                  </div>
                  ...
                  <div class="forminput">
                    ...
                    <select name="user_status" class='search-select-box' id="">
                      <option value="Admin" <?php echo $getDataRow['Gender'] == 'Admin' ? 'selected' : '' ?>>Admin
                      </option>
                      <option value="Staff" <?php echo $getDataRow['Gender'] == 'Staff' ? 'selected' : '' ?>>Staff
                      </option>
                    </select>
                  </div>
                ...
                <div>
                  <div class="forminput">
                    ...
                    <input name='password' type="password" class='search-area' placeholder="Enter Password Here"
                      autocomplete='off' />
                  </div>

                  <div class="forminput">
                    <label for="password2">Re-Enter Password</label>
                    <input name='password2' type="password" class='search-area' placeholder="Re-Enter Password Here"
                      autocomplete='off' />
                  </div>
                </div>
              ...
              <div class="formgrid">
                ...
                <div class="forminput">
                  ...
                  <input name='staff_id' type="text" class='search-area' readonly placeholder="Enter Username"
                    autocomplete='off' value='<?php echo $getDataRow['SN'] ?>' />
                </div>
                ...
                <div class="forminput">
                  ...
                  <input name='email1' type="email" class='search-area' readonly placeholder="Enter Email"
                    autocomplete='off' value='<?php echo $getDataRow['Email'] ?>' />
                </div>
