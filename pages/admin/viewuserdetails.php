            ...
            <div class="formgrid">
              ...
              <div class="forminput">
               <label for="username">Username</label>
                <input name='username' type="text" class='search-area' readonly placeholder="Enter Username" autocomplete='off' value='<?php echo $getDataRow_user['username'] ?>' />
              </div>
            ...
            <div class="formgrid">
              ...
              <div class="forminput">
               <label for="staff_id">Staff ID</label>
                <input name='staff_id' type="text" class='search-area' readonly placeholder="Enter Username" autocomplete='off' value='<?php echo $getDataRow_user['staff_id'] ?>' />
              </div>
            ...
            <div class="formgrid">
              ...
              <div class="forminput">
               <label for="password">Password</label>
                <input name='password' type="text" class='search-area' readonly placeholder="Enter First Name" autocomplete='off' value='<?php echo $getDataRow_user['password'] ?>' />
              </div>
