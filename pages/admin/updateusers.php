  ...
  <body class="dark">
    <div class="grid-section">
      ...
      <div class="right-section">
        <section class="home">
          <div class="text">Manage User</div>
        </section>
            ...
            <div class="formgrid">
              ...
              <div class="forminput">
               <label for="username">Username</label>
                <input name='username' type="text" class='search-area' placeholder="Enter Username" autocomplete='off' value='<?php echo $getDataRow_user['username'] ?>' />
              </div>
